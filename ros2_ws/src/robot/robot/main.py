...
STACK_TURN_MAX_ANGULAR_RAD_S = 1.2
...
INTER_DRIVE_MM = [
    130.0,   # patty → LB (traveling backward along shelf = positive forward)
    285.0,   # LB → RB (traveling forward along shelf)
    313.0,   # RB → Stack (traveling backward = positive forward in backward heading)
]
INTER_PAUSE_S = 0.25
...
# right-bun stop.
BUR_TRAVEL_12_ALIGN_FOV = 75.0   # side-wall FOV half-angle (deg)
