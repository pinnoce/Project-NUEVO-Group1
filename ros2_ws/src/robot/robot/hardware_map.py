...
LIDAR_MOUNT_X_MM = 237.0 # lidar mount offset from robot center wheel base (+x = forward)
LIDAR_MOUNT_Y_MM = 0.0   # (+y = left)
LIDAR_MOUNT_THETA_DEG = 0.0
LIDAR_RANGE_MIN_MM = 150.0
LIDAR_RANGE_MAX_MM = 6000.0
LIDAR_FOV_DEG = (-70,70)

TAG_BODY_OFFSET_X_MM = 185.0 # ArUco tag offset from wheel midpoint (+x = forward)
TAG_BODY_OFFSET_Y_MM = 0.0   # (+y = left)
